...
<body>
    <div class="container mt-4">
        ...
        <div id="Subject-Allotment-Main-Window">
            ...
            <div id="Subject-Allotment-Department" class="hidden">
                ...
                <!--Warning Messages-->
                <p>&nbsp;</p>
                <div class="alert alert-warning hidden" id="Subject-Allotment-Warning">
                    <strong>Note!</strong> Please enter a valid input in field <strong><span id="Subjec-Allotment-Error-Part"></span></strong>.
                </div>
                <!--Warning Messages-->
            </div>
        </div>
        
        <div id="Subject-Allotment-Edit-Window" class="hidden"></div>
    </div>
    ...
    //Change Programs
    $("#subject-allotment-department-program").change(function() {
        $("#subject-allotment-department-program option:selected").each(function() {});
        fetch_course_data();
    });
    
    //Change Course
    $("#subject-allotment-department-course").change(function() {
    ...
    function fetch_course_data() {
        $.ajax({
            ...
            success: function(data) {
                ...
                $("#subject-allotment-department-semester").append('<option value="1">Semester 1 AND 2</option>');
        ...
        if(program == 'null') {
            ...
            $.ajax({
                ...
                beforeSend: function() {
                    ...
                    $("#Subject-Allotment-Main-Window").addClass('hidden');
                },
                data: {
                ...
                error: function(xhr, status, error) {
                    $('#Spinner1').addClass('hidden');
                    $("#Subject-Allotment-Main-Window").removeClass('hidden');
    ...
    $(document).ready(function() {
        console.log("Subject Allotment page loaded");
